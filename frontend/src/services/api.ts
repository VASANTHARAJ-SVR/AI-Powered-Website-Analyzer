...
// Analyze a website in mobile mode
export const analyzeMobile = async (url: string): Promise<AnalyzeResponse> => {
    const response = await api.post('/api/analyze/mobile', { url });
    return response.data;
};
