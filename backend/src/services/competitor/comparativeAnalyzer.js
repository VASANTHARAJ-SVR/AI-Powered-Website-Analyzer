    ...
    competitive_opportunities: [
      {
        ...
        insight: 'Your performance score is lower than the top competitor.',
        recommendation: 'Focus on Core Web Vitals (LCP, CLS) to improve ranking.',
        impact: 'High'
      },
      {
        opportunity: 'Content Expansion',
        insight: 'Competitors may have more depth in content.',
        recommendation: 'Add more comprehensive content and improve keyword targeting.',
        impact: 'Medium'
      },
      {
        opportunity: 'Technical SEO',
        insight: 'Ensure basic technical SEO is flawless.',
        recommendation: 'Check meta tags, heading structure, and mobile responsiveness.',
        impact: 'High'
      }
    ]
  };
